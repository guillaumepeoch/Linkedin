	...
	<div class="container">
      ...
      <div class="col-md-5  toppad  pull-right col-md-offset-3 ">
       ...
       <br>
			...
			<br>
			<div
				class="col-xs-12 col-sm-10 col-md-8 col-lg-8 col-sm-offset-1 col-md-offset-2 col-lg-offset-2 toppad">
				...
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-12 col-lg-12 " align="center" id="image">
									<img class="img-circle" alt="User Pic"
										src="<c:out value="${profil.photoLinkedin}"/>">
							...
							<div class=" col-md-12 col-lg-12 ">
								<table class="table table-user-information">
									<tbody>
										...
										<tr>
											<td>URL Linkedin:</td>
											<td><a href="<c:out value="${profil.urlLinkedin}"/>"><c:out
														value="${profil.urlLinkedin}" /></a></td>
										</tr>
										<tr>
